      ...
      <div className="page-splash">
          ...
          <div className="slide-wrapper">
            <div className="slide-container">
              ...
              <br/>
              <p>Welcome.  The Automatic Thought Journal is a private micro blog for deconstructing cognitive distortions.  It's free, has no ads, no analytics, and your data is only saved locally to this browser.</p>
              <img src={Flowers} />
            </div>
          </div>
          <div className="slide-wrapper">
