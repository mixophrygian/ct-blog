  ...
  render() {
    return (
      <div className="page-about page">
        ...
        <blockquote>
          <i>
            "Your thoughts create your emotions; therefore, your emotions cannot prove that your
        ...
        <p>
          The Automatic Thought Journal is a tool designed to assist you in talking back to your own
          internal critic. It is a short exercise that helps you to overcome the bad habit of
          negative self-talk. Sometimes this self-talk can be so habitual and ingrained that these
          thoughts seem almost automatic; by consciously responding them, you can a) teach yourself
          to recognize these critical thoughts, b) learn why these thoughts may be distorted and c)
          develop a more realistic internal dialog for self-evaluation. One such way of responding
          is by stepping through the thought and systematically breaking it down into discrete
          sections. Doing so can make it easier to identify distortions that may be occurring and,
          as a result, consider a new reaction to a potentially upsetting situation. This is the
          essence of the automatic thought journal.
        </p>
        <h2>How it works</h2>
        <p>
        ...
        <p>
          Forget about it for a few days and come back to it later. The more you practice breaking
          down thoughts, the easier it will get. Don't be afraid to ask other people how they would
          respond to an upsetting thought if you can't figure out the rational response on your own.
        </p>

        <h3>Why not just use the original version?</h3>
        <p>
          In the three column version it's easy to intermingle emotional responses with both the
          situation and the cognitive distortion. By breaking down the first step into three
          sections, you can clearly separate the three to better identify a) the situation itself,
          e.g. "I forgot my friend's birthday", b) the thoughts that are simply emotional reactions,
          such as "I feel terrible", and c) the thoughts that are distorted conclusions "I'm no
          good."
        </p>
        ...
        <p>
          ...
          depression. 1979. New York: Guilford Press
        </p>
        <p>
          <span id="firstAsterix">*</span>This method was originally created by David Burns and
          termed the "triple-column technique" in his book "Feeling Good" (year), and later
        ...
        <p>
          I try my best to correctly attribute all sources of original work and will gratefully
          welcome any corrections.
        </p>
        <h2>Disclaimer</h2>
        <p>
          I'm not a doctor and the explanation of this exercise is meant more as a refresher for
          those who have already been introduced rather than a complete, stand-alone explanation.
        </p>
      </div>
    );
  }
